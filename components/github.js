...
export const Commit = () => {
  ...
  return (
    <div className="flex item-center flex-col justify-center relative dark:text-white p-9 rounded-3xl shadow-xl hover:scale-110 transition-all bg-mesh bg-no-repeat">

...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center' ref={ref}>
      ...
      {/* Presentation block */}
      <Section direction='flex-row' margin='mt-28'>
      ...
      {/* Stats block */}
      <Section direction='flex-col' margin='mb-20'>
        <div className='flex flex-col lg:flex-row justify-around lg:my-10'>
          <div className='rounded-3xl shadow-2xl lg:w-1/2 px-10 py-20 mb-10 md:mb-0 dark:bg-sdark bg-cover'>
            ...
            <div className='flex flex-col pt-5 lg:py-16'>
              ...
              <div
                className='flex item-center flex-col justify-center relative bg-yellow dark:text-white p-9 rounded-3xl shadow-xl hover:scale-110 transition-all bg-[url(../public/mesh-3.png)] bg-no-repeat'>
                <FaPlus className='text-[26px] absolute right-7 top-3' />
                <p className='text-8xl text-bold text-center'>9/10</p>
                <h2 className='text-bold text-2xl text-center font-poppins'>Avis client</h2>
              </div>
            </div>
          </div>
          <div className='flex flex-col items-center justify-between lg:ml-10 sm:mt-10 lg:mt-0'>
            ...
            <div
              className='rounded-full shadow-2xl h-1/4 text-black lg:p-16 p-12 md:mt-10 lg:mt-0 w-full bg-[url(../public/mesh-2.png)] dark:bg-[url(../public/mesh.png)] hover:bg-[url(../public/mesh.png)] dark:hover:bg-[url(../public/mesh-2.png)] bg-no-repeat bg-cover dark:shadow-blue-500/50 transition-all' />
          </div>
        </div>
      </Section>
      ...
      {/* About block */}
      <Section direction='flex-col' margin='mb-20'>
        <div className='flex lg:flex-row flex-col items-center justify-between w-full mb-15'>
          <h2 className='text-6xl font-bold text-center lg:w-1/4 mb-5'>
            Qui je suis ?
          </h2>
          <div
            className='rounded-full md:hidden lg:block shadow-2xl lg:h-[70px] h-[20px] text-black w-2/3 bg-[url(../public/mesh-2.png)] dark:bg-[url(../public/mesh.png)] hover:bg-[url(../public/mesh.png)] dark:hover:bg-[url(../public/mesh-2.png)] bg-no-repeat bg-cover dark:shadow-blue-500/50 transition-all' />
        </div>
        ...
        <div className='flex lg:flex-row flex-col justify-center items-center'>
          <h2 className='lg:text-7xl text-5xl font-bold lg:px-0 px-5 text-center'>
            Let&apos;s go a ma rencontre ?
          </h2>
          <Image src={profile} alt='Photo de profile' className='lg:w-6/12 w-2/3 lg:mt-0 mt-10' />
        </div>
      </Section>

      {/* Works block */}
      <Section margin='lg:mt-0 mt-20 mb-20' direction='flex-col'>
        ...
        <div className='lg:grid lg:grid-cols-2 lg:gap-10 flex flex-col justify-around mt-10 md:mx-10 lg:mx-0'>
          ...
          >
            Création d&apos;une application CRM pour freelance pour gérer son entreprise.
          </WorkItem>
        </div>
      </Section>
    </div>
